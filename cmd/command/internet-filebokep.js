diff --git a/cmd/command/internet-filebokep.js b/cmd/command/internet-filebokep.js
index 62add96ace308ac7baa2a7f924a8748a185a8cc0..8dbe5e88702ead148044e120bbe0f13691935312 100644
--- a/cmd/command/internet-filebokep.js
+++ b/cmd/command/internet-filebokep.js
@@ -1,58 +1,24 @@
...
+    cmd: ['filebokep'],
+    tags: 'Internet Menu',
+    desc: 'Random file bokep',
+    owner: false,
+    prefix: true,
+    run: async (xp, m, { chat }) => {
+      await xp.sendMessage(chat.id, { text: '⏳ [!] Please Wait, Tunggu Sebentar...' }, { quoted: m })
+      await xp.sendMessage(chat.id, { text: pickRandom(bokep) }, { quoted: m })
+    }
+  })
+}
